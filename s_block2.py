def s_box_inverse(input_block):
    ...
    output_tetrad1 = s_box_inverse[tetrad1 >> 2][tetrad1 & 0x04] #функція заміни значень за допомогою блоку
    output_tetrad2 = s_box_inverse[tetrad2 >> 2][tetrad2 & 0x04]
